...
export '/pages/buscar/buscar_widget.dart' show BuscarWidget;
...
export '/pages/registrarse/registrarse_widget.dart' show RegistrarseWidget;
export '/pages/verificacion_correo/verificacion_correo_widget.dart'
