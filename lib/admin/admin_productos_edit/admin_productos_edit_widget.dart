...
import 'admin_productos_edit_model.dart';
export 'admin_productos_edit_model.dart';

class AdminProductosEditWidget extends StatefulWidget {
  const AdminProductosEditWidget({
    super.key,
  ...
  @override
  State<AdminProductosEditWidget> createState() =>
      _AdminProductosEditWidgetState();
}

class _AdminProductosEditWidgetState extends State<AdminProductosEditWidget> {
  late AdminProductosEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminProductosEditModel());
    ...
    _model.imageTextController ??= TextEditingController(
        text: widget.product?.hasImageGoogle().toString());
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                await widget.product!.reference
                                  ...
                                  imageGoogle: _model.imageTextController.text,
                                ));
